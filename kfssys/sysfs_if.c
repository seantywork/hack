...
MODULE_DESCRIPTION("LKP-2 book:ch2/sysfs_if: simple sysfs interfacing demo");
/*
...
static int __init sysfs_if_init(void)
{
	int stat = 0;
	 ...
	 */
#define PLAT_NAME	"llkd_sysfs_if_device"
...
static void __exit sysfs_if_cleanup(void)
{
	/* Cleanup sysfs nodes */
...
module_init(sysfs_if_init);
module_exit(sysfs_if_cleanup);