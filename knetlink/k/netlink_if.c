...
MODULE_DESCRIPTION("ch2/netlink_if: simple netlink recv/send demo kernel module");
MODULE_LICENSE("Dual MIT/GPL");
MODULE_VERSION("0.1");

#define OURMODNAME   "netlink_if"
...
static int __init netlink_if_init(void)
{
...
static void __exit netlink_if_exit(void)
{
	netlink_kernel_release(nlsock);
	pr_info("removed\n");
}

module_init(netlink_if_init);
module_exit(netlink_if_exit);