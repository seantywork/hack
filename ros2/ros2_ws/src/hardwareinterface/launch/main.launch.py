...
def generate_launch_description():
    ...
    # equivalent to
    # $ xacro ~/agv_ws/install/agv_base/share/agv_base/description/robot.urdf.xacro sim_mode:=false
    ...
    # equivalent to
    # $ ros2 run robot_state_publisher robot_state_publisher --ros-args -p robot_description:="$( xacro ~/agv_ws/install/agv_base/share/agv_base/description/robot.urdf.xacro )"
    ...
    # equivalent to
    # $ ros2 run controller_manager ros2_control_node --ros-args -p robot_description:="$( xacro ~/agv_ws/install/agv_base/share/agv_base/description/robot.urdf.xacro )" --params-file ~/agv_ws/install/agv_base/share/agv_base/config/diffbot_controllers.yaml
